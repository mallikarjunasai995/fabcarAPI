...
exports.invokeSDK = async function(fnName,reqBody,reply) {
	console.log('\n\n --- invoke.js - start');
	console.log('funcname received:'+fnName);
	var arg2 = reqBody.Args;
	console.log("reqbody from arg1 after ramana fnName", arg2);
	try {
		...
		console.log('Used service discovery to initialarg2ize the channel');
		...
		if (results[1] instanceof Error) {
			...
			reply.send("mallik success we are here finally after committing the trasnsaction")
		} else {
